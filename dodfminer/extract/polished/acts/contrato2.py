            ...
            for orgao in section_3:
                for documento in section_3[orgao]:
                    for ato in section_3[orgao][documento]:
                        if "contrato" in section_3[orgao][documento][ato]['titulo'].lower() or "convênio" in section_3[orgao][documento][ato]['titulo'].lower():
                            atos_contrato_convenio.append(re.sub(r'<[^>]*>', '', section_3[orgao][documento][ato]['texto']))
