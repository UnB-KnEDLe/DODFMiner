"""Regras regex para ato de Aviso de Adiamento de Licitação."""
...
class AdiamentoLicitacao(Atos):

    def __init__(self, file, backend):
        super().__init__(file, backend)

    def _act_name(self):
        return "Adiamento de Licitação"
    ...
    def _rule_for_inst(self):
        start = r"(AVISO(?:S)?\s+D[EO]\s+ADIAMENTO\s+D[EO]\s+LICITACAO)"
